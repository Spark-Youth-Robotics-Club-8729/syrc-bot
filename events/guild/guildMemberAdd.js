...
module.exports = (Discord, client, member) => {
    ...
    const message = `Welcome <@${member.id}> to FRC team 8729: Sparkling H2O! Check out ${rolechannel.name} to get roles and ${linkschannel.name} for useful links throughout your journey. Awesome to have you here :D`;
